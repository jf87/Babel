...
The problem has been recognized in the BuildSys community.
XXX, XXX (BAS) mention inconsistent metadata as a problem but don't further investigate a solution. \fixme{bas, boss paper}
